...
public class Aggregator extends Thread
{
    ...
    private void aggregateTables(Statement s, String table, Calendar currTime)
    {
        ...
        if (isHourTable)
        {
            ...
            if ((currTime.getTimeInMillis() - tableTime.getTimeInMillis()) <=
                (days * 24 * 60 * 60 * 1000 + 30 * 60 * 1000))
            {
                return;
            }
        ...
        else
        {
            ...
            // check if current table is older than specified time in config file
            if ((currTime.getTimeInMillis() - tableTime.getTimeInMillis()) <=
                (days * 2 * 7 * 24 * 60 * 60 * 1000 + 1 * 24 * 60 * 60 * 1000))
            {
                return;
            }
        ...
        try
        {
            if (false && !knownTables.contains(aggregationTable))
            {
                s.executeUpdate("CREATE TABLE IF NOT EXISTS " + aggregationTable +
                                "_tmp (srcIP INTEGER(10) UNSIGNED, dstIP INTEGER(10) UNSIGNED," +
    ...
    private void removeDuplicates(Statement s, String table)
    {
        ...
        try
        {
            ...
            s.executeUpdate("INSERT INTO " + table +
                            " (SELECT SQL_BIG_RESULT srcIP, dstIP, srcPort, dstPort, proto, SUM(bytes), SUM(pkts), MIN(firstSwitched), MAX(lastSwitched), exporterID, SUM(aggFlows)" +
    ...
    private void aggregateTablesOnlyPortsGreater1024(Statement s, String table, Calendar currTime)
    {
        ...
        else
        {
            ...
            // check if current table is older than specified time in config file
            if ((currTime.getTimeInMillis() - tableTime.getTimeInMillis()) <=
                (days * 7 * 24 * 60 * 60 * 1000 + 1 * 24 * 60 * 60 * 1000))
            {
                return;
            }
        ...
        try
        {
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort<1024 AND dstPort<1024 GROUP BY srcIP, dstIP, srcPort, dstPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort<1024  AND dstPort>=1024 GROUP BY srcIP, dstIP, srcPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort>=1024  AND dstPort<1024 GROUP BY srcIP, dstIP, dstPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort>=1024  AND dstPort>=1024 GROUP BY srcIP, dstIP, proto, exporterID)");
    ...
    private void aggregateTablesByDstSubnet24AndPortsGreater1024(Statement s, String table, Calendar currTime)
    {
        ...
        try
        {
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort<1024 AND dstPort<1024 GROUP BY srcIP, dstSubnet, srcPort, dstPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort<1024 AND dstPort>=1024 GROUP BY srcIP, dstSubnet, srcPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort>=1024 AND dstPort<1024 GROUP BY srcIP, dstSubnet, dstPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort>=1024 AND dstPort>=1024 GROUP BY srcIP, dstSubnet, proto, exporterID)");
    ...
    private void aggregateTablesBySrcAndDstSubnet24AndPortsGreater1024(Statement s, String table, Calendar currTime)
    {
        ...
        try
        {
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort<1024 AND dstPort<1024 GROUP BY srcSubnet, dstSubnet, srcPort, dstPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort<1024 AND dstPort>=1024 GROUP BY srcSubnet, dstSubnet, srcPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort>=1024 AND dstPort<1024 GROUP BY srcSubnet, dstSubnet, dstPort, proto, exporterID)");
            s.executeUpdate("INSERT INTO " + aggregationTable + "_tmp" +
                            ...
                            table +
                            " WHERE srcPort>=1024 AND dstPort>=1024 GROUP BY srcSubnet, dstSubnet, proto, exporterID)");
    ...
    private void removeDuplicatesWithSubnetsAndAnyPorts(Statement s, String table)
    {
        ...
        try
        {
            ...
            s.executeUpdate("INSERT INTO " + table +
                            " (SELECT SQL_BIG_RESULT srcIP, dstIP, proto, SUM(bytes), SUM(pkts), MIN(firstSwitched), MAX(lastSwitched), exporterID, SUM(aggFlows)" +
